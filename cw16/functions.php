...
function fullSearch(string $wynik):int{
$n=1;
global $texts;
$max = sizeof($texts);
for($i=0;$i<$max;$i++){
if(mb_strpos($texts[$i],$wynik)==false){}
else{$n++;}
$d=$n;
return $d;
}
    ...
    $texts = [
        ...
        "Witaj dobry człowieku","programowanie w php nie jest takie trudne","Już za chwilę święta","Trawa zielona jest","Ryby, ptaki, kleszcze to leszcze",
        "Wiertarka w kocu nie płacze"
    ];